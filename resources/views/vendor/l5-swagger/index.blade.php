...
<head>
    ...
    *:after
    ...
    /* Solo ajuste para el header fijo */
    #swagger-ui {
        margin-top: 60px;
    }
    </style>
...
<!-- Header de usuario con Bootstrap -->
<nav class="navbar navbar-light bg-white border-bottom shadow-sm fixed-top">
    <div class="container-fluid">
        <div class="d-flex align-items-center">
            <div>
                <div class="fw-bold text-dark">{{ auth()->user()->full_name ?? 'Admin User' }}</div>
    ...
    window.onload = function() {
        ...
        const ui = SwaggerUIBundle({
            ...
            requestInterceptor: function(request) {
                ...
                // Incluir credenciales para cookies de sesión
